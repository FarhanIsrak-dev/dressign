...
class CheckoutsController extends Controller
{
  ...
  */
  public function index()
  {
    ...
    return view('user.checkouts', compact('payments'));
  }
  ...
  */
  public function store(Request $request)
  {
    ...
    session()->flash('success', 'Your order has been taken successfully !!! Admin will soon confirm your order');
  ...
  {
    $payments = Payment::orderBy('priority', 'asc')->get();
    return view('user.designs.kamiz_design', compact('payments'));
  }
