...
<div class='container margin-top-20 mb-3'>
    <div class="card card-body">
      <h2><strong>Confirm Items</strong></h2>
      <hr>
      ...
      <p>
        ...
        <a href="{{ route('carts') }}"><button type="submit" class="btn btn-primary">
              Change Cart Items
            </button></a>
      </p>
    </div>
            ...
            @foreach ($payments as $payment)
              @if ($payment->short_name == "cash_in")
                <div id="payment_{{ $payment->short_name }}" class="alert alert-success mt-2 text-center hidden">
                  <h3>
                    For Cash On Delivery there is nothing necessary. Just click Finish Order.
                    <br>
                    <small>
                      You will get your product in two or three business days.If it is for dress design then you will
                      get it within 2 weeks
                    </small>
                  </h3>
                </div>
              @else
                <div id="payment_{{ $payment->short_name }}" class="alert alert-success mt-2 text-center hidden"
                  ...
                  <div class="alert alert-success">
                    Please send the above money to this phone no. and write down your transaction code below there..
                  </div>
